...
private:
    ...
    void _addKnob(Parameters paramId, const char* label, float v_min, float v_max, const ImGuiKnobs_Mod::KnobScaleMark *marks, uint32_t mark_count, bool isLogarithmic = false); // Helper function to add a knob with given parameters (called from onImGuiDisplay)
