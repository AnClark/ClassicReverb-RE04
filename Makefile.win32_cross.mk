...
check_dependencies:
	@which x86_64-w64-mingw32-g++ > /dev/null || (echo "Error: x86_64-w64-mingw32-g++ is not installed. Please install MinGW-w64." && exit 1)
...
configure: check_dependencies
	...
	@echo "SET(CMAKE_C_COMPILER $(shell which x86_64-w64-mingw32-gcc))" >> $(WIN32_TOOLCHAIN_FILE)
	@echo "SET(CMAKE_CXX_COMPILER $(shell which x86_64-w64-mingw32-g++))" >> $(WIN32_TOOLCHAIN_FILE)
	@echo "SET(CMAKE_RC_COMPILER $(shell which x86_64-w64-mingw32-windres))" >> $(WIN32_TOOLCHAIN_FILE)
	@echo "SET(CMAKE_FIND_ROOT_PATH $(shell x86_64-w64-mingw32-gcc -print-sysroot) ${PREFIX_PATH})" >> $(WIN32_TOOLCHAIN_FILE)
